...
echo.
echo Next steps:
echo 1. Double click "Start NicFlix.bat" to run the app.
echo 2. Open Admin in NicFlix and add your media folders.
echo 3. Add and test your TMDB API key from Admin if you want metadata lookup.
echo.
